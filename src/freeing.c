...
/*   Updated: 2024/05/16 13:02:15 by bperez-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void free_commands(t_command *commands)
{
	...
	while (current_command)
	{
		...
		if (current_command->redirect_in)
			free_redirects(current_command->redirect_in);
		if (current_command->redirect_out)
			free_redirects(current_command->redirect_out);
